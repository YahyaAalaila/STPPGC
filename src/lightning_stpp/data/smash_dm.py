...
class _SMASHSeqDataset(torch.utils.data.Dataset):
    """
...
@LightDataModule.register("smash")
class SMASHDataModule(LightDataModule):

    def __init__(self, data_cfg):
        super().__init__(data_cfg)

    def _wrap(self, split, reference_min=None, reference_max=None):
        ds = _SMASHSeqDataset(split, log_norm=self.data_config.log_normalisation)
